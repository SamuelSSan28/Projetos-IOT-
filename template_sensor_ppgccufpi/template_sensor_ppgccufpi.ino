...
const char* topicoTemperatura = "ufpi/ppgcc/esp-dht22-node08/temperatura";
const char* topicoUmidade = "ufpi/ppgcc/esp-dht22-node08/umidade";
...
void setup() {
  ...
  WiFi.hostname("esp-dht22-node08");
